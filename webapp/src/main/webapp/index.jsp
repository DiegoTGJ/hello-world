<form action="action_page.php">
  <div class="container">
    ...
    <label for="psw-repeat"><b>Repita la contrase&tilde;a</b></label>
    <input type="password" placeholder="Repeat Password" name="psw-repeat" id="psw-repeat" required>
    <hr>
    <br>
    <p>Al crear una cuenta aceptas los terminos y condiciones <a href="#">Terms & Privacy</a>.</p>
